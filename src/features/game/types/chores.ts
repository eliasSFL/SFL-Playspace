...
export const CHORES: Chore[] = [
  {
    ...
    introduction: translate("chores.harvestFieldsIntro", { count: 3 }),
    requirement: 3,
    reward: {
      items: {},
    },
  ...
  {
    description: translate("chores.earnSfl", {
      amount: CROPS().Sunflower.sellPrice.mul(5).toString(),
    }),
  ...
  {
    description: translate("chores.reachLevel", { level: 2 }),
    bumpkinLevel: 2,
    image: bruce,
  ...
  },
  {
    ...
    description: translate("chores.chopTrees", { count: 3 }),
    requirement: 3,
    image: workbench,
