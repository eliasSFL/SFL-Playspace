...
const generalTerms: Record<GeneralTerms, string> = {
  ...
  accept: "Accettaret:",
  "accepting.terms": "Accettazione dei termini.",
  "amount.matic": "Importo in MATIC",
  deposit: "Deposito",
  add: "Aggiungere",
  addSFL: "Aggiungere SFL",
  "add.liquidity": "Aggiungere liquidità’",
  "alr.bought": "Già acquistato!",
  "alr.claim": "Già richiesto",
  "alr.completed": "Già completato",
  "alr.crafted": "Già creato",
  "alr.minted": "Già coniato",
  auction: "Asta",
  auctions: "Aste",
  "available.all.year": "Disponibile tutto l’anno",
  available: "Disponibile",
  back: "Indietro",
  bait: "Esca",
  balance: "Saldo",
  basket: "Cesto",
  "beach.bounty": "Spiaggia della ricompensa",
  beta: "Beta",
  bid: "Offerta",
  bounty: "Ricompensa",
  build: "Costruire",
  buy: "Comprare",
  cancel: "Annullare",
  "card.cash": "Carta / Denaro",
  caught: "Catturato",
  "change.Language": "Cambia la lingua",
  check: "Controllare",
  chest: "Forziere",
  chores: "Compiti",
  "choose.wisely": "Scegli con attenzione",
  claim: "Reclamare",
  "claim.gift": "Reclama il regalo",
  "claim.skill": "Reclama l’abilità",
  clear: "Cancella",
  close: "Chiudi",
  collect: "Raccogliere",
  ...
  deliver: "Consegnare",
  deliveries: "Consegne",
  "deliveries.closed": "Consegne chiuse",
  delivery: "Consegna",
  details: "Dettagli:",
  donate: "Donare",
  donating: "Donare",
  "drafting.noitem": "Nessun elemento disponibile da mettere in vendita",
  "drafting.select": "Seleziona un elemento da mettere in vendita",
  "drafting.trade.detail": "Dettagli dello scambio",
  dragMe: "Trascinami",
  earn: "Guadagno",
  "easter.eggs": "Uova di pasqua",
  egg: "Uovo",
  empty: "Vuoto",
  "enjoying.event": "Apprezzando questo evento?",
  equip: "Equipaggia",
  error: "Errore",
  exotics: "Esotico",
  "expand.land": "Espandi la tua Isola",
  expand: "Espandi",
  explore: "Esplora",
  farm: "Fattoria",
  "farm.storage": "Deposito della fattoria",
  featured: "Pubblicato",
  fee: "Commissione",
  "feed.bumpkin": "Alimenta il contadino",
  fertilisers: "Fertilizzanti",
  fish: "Pesce",
  "fish.caught": "Pesce pescato",
  flowers: "Fiori",
  "flowers.found": "Fiori trovati",
  foods: "Cibi",
  for: "per",
  "for.info.wearable": "per più informazioni riguardo questo indossabile",
  forbidden: "Vietato",
  "free.trade": "Scambio gratuito",
  fruit: "Frutta",
  fruits: "Frutti",
  gift: "Regalo",
  "go.home": "Torna a casa",
  "goblin.delivery":
    "I Goblin trattengono la riduzione delle consegne nella tesoreria. Guardali anche su",
  gotIt: "Preso",
  goto: "Vai a",
  "grant.wish": "Concedi un nuovo desiderio",
  guide: "Guida",
  harvested: "Raccolto",
  honey: "Miele",
  "hungry?": "Affamato?",
  ...
  left: "Sinistra",
  "let'sDoThis": "Facciamolo!",
  "lets.go": "Andiamo!",
  limit: "Limite",
  "linked.wallet": "Portafoglio collegato",
  list: "Elenco",
  "list.trade": "Listino di scambio",
  loading: "Caricamento",
  locked: "Bloccato",
  logout: "Disconnettersi",
  "loser.refund": "Rimborsa le risorse",
  lvl: "Livello",
  maintenance: "Manutenzione",
  "make.wish": "Esprimi un desiderio",
  "making.wish": "Esprimendo un desiderio",
  max: "Massimo",
  message: "Messaggio",
  messages: "Messaggi",
  minimum: "Minimo",
  ...
  music: "Musica",
  next: "Successivo",
  "next.order": "Ordine successivo",
  nextSkillPtLvl: "Punto abilità successivo: Livello",
  no: "No",
  "no.delivery.avl": "Nessuna consegna disponibile",
  "no.event": "Nessun evento",
  "no.have.bumpkin": "Tu non hai un contadino!",
  "no.limits.exceeded": "Nessun limite superato",
  "no.mail": "La tua cassetta postale è piena!",
  "no.obsessions": "Nessuna Ossessione",
  "no.thanks": "No grazie",
  "ocean.fishing": "Pesca Oceanica",
  off: "Off",
  "offer.end": "L’offerta termina tra",
  ok: "OK",
  on: "Su",
  open: "Aprire",
  "open.gift": "Apri il regalo",
  "pass.required": "Pass richiesto",
  place: "Posto",
  "place.map": "Posto sulla mappa",
  "place.bid": "Fai la tua offerta",
  "placing.bid": "Fare un’offerta",
  plant: "Pianta",
  "play.again": "Gioca di nuovo",
  "please.try.again": "Per favore riprova più tardi.",
  "please.wait": "Attendere prego",
  "pay.attention.feedback": "Presta attenzione alle icone di feedback:",
  print: "Stampa",
  "promo.code": "Codice promozionale",
  "providing.liquidity": "Fornire liquidità",
  purchased: "acquistato",
  purchasing: "Acquisto",
  rank: "Rango",
  rare: "Raro",
  "read.more": "Per saperne di più",
  "ready.trade": "Pronto per fare trading?",
  refresh: "ricaricare",
  refreshing: "Ricaricando",
  remaining: "residuo",
  "remaining.trades": "Scambi rimanenti",
  remove: "Rimuovi",
  reqSkillPts: "Punti abilità richiesti:",
  reqSkills: "Abilità richieste:",
  required: "Necessario",
  requires: "Richiede",
  resale: "Rivendita",
  resources: "Risorse",
  ...
  retry: "Riprovare",
  reward: "Ricompensa",
  "reward.discovered": "Ricompensa trovata",
  save: "Salva",
  saving: "Salvataggio",
  search: "Ricerca",
  searching: "Ricercando",
  "seasonal.treasure": "Tesoro stagionale",
  seeds: "Semi",
  selected: "Selezionati",
  "select.resource": "Seleziona la tua risorsa",
  sell: "Vendi",
  "sell.all": "Vendi tutto",
  "sell.one": "Vendi 1",
  "sell.ten": "Vendi 10",
  "session.expire": "la tua sessione è scaduta",
  "session.expired": "Sessione scaduta!",
  settings: "Impostazioni",
  share: "Condividi",
  shopping: "Shopping",
  skillPts: "Punti abilità:",
  skills: "Abilità:",
  skipping: "saltando",
  "skip.order": "Salta ordine",
  "sound.effects": "Effetti sonori:",
  "special.event": "Evento speciale",
  spin: "Rotazione",
  start: "Inizio!",
  "start.new.chore": "Inizia un nuovo lavoro",
  submit: "Invia",
  submitting: "Inviando",
  success: "Successo!",
  "support.team": "Team di supporto",
  swapping: "scambio",
  ...
  test: "Test",
  "thank.you": "Grazie!",
  "there.currently": "Attualmente esiste",
  time: "Tempo",
  tools: "Attrezzi",
  total: "Totale",
  trades: "Scambi",
  ...
  "trash.collection": "Raccolta dei rifiuti",
  travel: "Viaggio",
  "traveller.ready": "Hey viaggiatore, sei pronto per esplorare?",
  "try.again": "Riprova",
  uhOh: "Uh oh!",
  uncommon: "Non comune",
  "unlock.land": "Sblocca più terreni",
  unlocking: "Sbloccare",
  unmute: "Riattiva audio",
  "use.craft": "Usato per creare oggetti",
  verify: "Verifica",
  version: "Versione",
  viewAll: "Vedi tutto",
  visit: "Visita",
  "visit.enter.land":
    "Inserisci un ID terreno per scoprire cosa c'è in offerta",
  "visit.friend": "Visita un amico",
  "visit.land": "Visita un terreno",
  wallet: "Portafoglio",
  warning: "Attenzione",
  welcome: "Benvenuto!",
  ...
  "hoarding.check": "controllo dell'accumulo",
  opensea: "Opensea",
...
const achievementTerms: Record<AchievementsTerms, string> = {
  "breadWinner.description": "Ottieni 0.001 SFL",
  "breadWinner.one":
    "Bene, bene, bene, socio... sembra che tu abbia bisogno di un po' di SFL!",
  "breadWinner.two":
    "In Sunflower Land, una sana scorta di SFL è la chiave per la creazione di strumenti, edifici e NFT rari",
  "breadWinner.three":
    "Il modo più rapido per guadagnare SFL è piantare e vendere colture.",

  "sunSeeker.description": "Raccolto Girasole 100 volte",
  "cabbageKing.description": "Raccolto Cavolo 200 volte",
  "jackOLantern.description": "Raccogliere la Zucca 500 volte",
  "coolFlower.description": "Raccolto Cavolfiore 100 volte",
  "farmHand.description": "Raccolte colture 10.000 volte",
  "beetrootBeast.description": "Raccolto Barbabietola 2.000 volte",
  "myLifeIsPotato.description": "Raccolto di patate 5.000 volte",
  "rapidRadish.description": "Raccolto Ravanello 200 volte",
  "twentyTwentyVision.description": "Raccolto Carota 10.000 volte",
  "stapleCrop.description": "Raccolto Grano 10.000 volte",
  "sunflowerSuperstar.description": "Raccolta Girasole 100.000 volte",
  "bumpkinBillionaire.description": "Guadagna 5.000 SFL",
  "patientParsnips.description": "Raccolto Pastinaca 5.000 volte",
  "cropChampion.description": "Raccolto 1 milione di colture",

  "busyBumpkin.description": "Raggiungere il livello 2",
  "busyBumpkin.one":
    "Salve, mio ambizioso amico! Per sbloccare nuovi raccolti, espansioni, edifici e molto altro ancora dovrai salire di livello.",
  "busyBumpkin.two":
    "Vai al Fire Pit, cucina una deliziosa ricetta e dai da mangiare al tuo Bumpkin.",

  "kissTheCook.description": "Cucinare 20 pasti",
  "bakersDozen.description": "Cuocere 13 torte",
  "brilliantBumpkin.description": "Raggiungere il livello 20",
  "chefDeCuisine.description": "Cucinare 5.000 pasti",

  "scarecrowMaestro.description":
    "Crea uno spaventapasseri e migliora le tue colture",
  "scarecrowMaestro.one":
    "Heilà, socio! E 'tempo di imparare l'arte della lavorazione e aumentare le vostre abilità di agricoltura",
  "scarecrowMaestro.two":
    "Viaggia al Pumpkin Plaza, visita il fabbro e crea uno spaventapasseri.",

  "bigSpender.description": "Spendere 10 SFL",
  "museum.description":
    "Avere 10 diversi tipi di oggetti rari posizionati sulla tua terra",
  "highRoller.description": "Spendi 7.500 SFL",
  "timbeerrr.description": "Tagliare 150 alberi",
  "craftmanship.description": "Creare 100 strumenti",
  "driller.description": "Estrarre 50 rocce di pietra",
  "ironEyes.description": "Estrarre 50 rocce di ferro",
  "elDorado.description": "Estrarre 50 rocce di oro",
  "timeToChop.description": "Creare 500 asce",
  "canary.description": "Estrarre 1000 rocce di pietra",
  "somethingShiny.description": "Estrarre 500 rocce di ferro",
  "bumpkinChainsawAmateur.description": "Tagliare 5,000 alberi",
  "goldFever.description": "Estrarre 500 rocce di oro",

  // Explorer
  "explorer.one":
    "Raccogliamo un po' di legno abbattendo questi alberi ed espandendo l'isola. Vai avanti e scopri il modo migliore per farlo.",
  "expansion.description": "Espandi la tua terra verso nuovi orizzonti.",

  // Well of Prosperity
  "wellOfProsperity.description": "costruire un pozzo",
  "wellOfProsperity.one": "Bene, bene, bene, cosa abbiamo qui?",
  "wellOfProsperity.two":
    "Sembra che i vostri raccolti sono assetati. Per sostenere più colture è necessario prima costruire un pozzo.",

  "contractor.description": "Costruisci 10 edifici sulla tua terra",
  "fruitAficionado.description": "Raccogliere 50 frutti",
  "fruitAficionado.one":
    "Hey là, raccoglitore della frutta! I frutti sono regali più dolci della natura e portano un esplosione di sapore alla vostra azienda agricola.",
  "fruitAficionado.two":
    "Raccogliendo diversi frutti, come mele, arance e mirtilli, sbloccherai ricette uniche, migliorerai le tue abilità culinarie e creerai deliziose prelibatezze",

  "orangeSqueeze.description": "Raccogli le arance 100 volte.",
  "appleOfMyEye.description": "Raccogli le mele 500 volte.",
  "blueChip.description": "Raccogli mirtilli 5.000 volte.",
  "fruitPlatter.description": "Raccogli 50,000 frutti",
  "crowdFavourite.description": "Completa 100 consegne",

  "deliveryDynamo.description": "Completa 3 consegne",
  "deliveryDynamo.one":
    "Salve, buon coltivatore! Ai contadini serve il tuo aiuto per le consegne.",
  "deliveryDynamo.two":
    "Completando le consegne, li renderai felici e guadagnerai fantastici premi SFL in cambio",

  "seasonedFarmer.description": "Raccogliere 50 risorse stagionali",
  "seasonedFarmer.one":
    "Salve, avventuriero stagionale! Sunflower Land è nota per le sue stagioni speciali piene di oggetti unici e sorprese.",
  "seasonedFarmer.two":
    "Raccogliendo risorse stagionali, avrai accesso a ricompense a tempo limitato, creazioni esclusive e tesori rari. È come avere un biglietto in prima fila per le meraviglie di ogni stagione.",
  "seasonedFarmer.three":
    "Quindi completa i compiti, partecipa agli eventi e raccogli i biglietti stagionali per goderti il meglio che Sunflower Land ha da offrire!",
  "treasureHunter.description": "Scavare 10 buche",
  "treasureHunter.one":
    "Ahoy, cacciatore di tesori! Sunflower Land è pieno di tesori nascosti in attesa di essere scoperti.",
  "treasureHunter.two":
    "Afferra la pala e dirigiti all’Isola del Tesoro, dove puoi scavare per trovare oggetti preziosi e sorprese rare.",
  "eggcellentCollection.description": "Raccogli 10 Uova",
  "eggcellentCollection.one":
    "Salve, raccoglitore di uova! I polli sono meravigliosi compagni di fattoria che ci forniscono deliziose uova.",
  "eggcellentCollection.two":
    "Raccogliendo le uova, avrai una nuova scorta di ingredienti per cucinare, e potrai anche sbloccare ricette speciali e bonus.",
  "task.harvestSunflowers": "Raccogliere 10 Girasoli",
};

const addSFL: Record<AddSFL, string> = {
  "addSFL.swapDetails":
    "Sunflower Land fornisce un modo rapido per scambiare Matic per SFL tramite Quickswap.",
  "addSFL.referralFee":
    "Sunflower Land richiede una commissione di referral del 5% per completare questa transazione.",
  "addSFL.swapTitle": "Dettagli di scambio",
  "addSFL.minimumReceived": "Minimo ricevuto",
};

const auction: Record<Auction, string> = {
  "auction.title": "Aste e Drop",
  "auction.bid.message": "Hai fatto la tua offerta.",
  "auction.reveal": "Rivelare i vincitori",
  "auction.live": "L'asta è aperta!",
  "auction.requirement": "requisiti",
  "auction.start": "orario di inizio",
  "auction.period": "periodo dell'asta",
  "auction.closed": "Asta chiusa",
  "auction.const": "in costruzione!",
  "auction.const.soon": "Questa funzione è in arrivo.",
};

const availableSeeds: Record<AvailableSeeds, string> = {
  "availableSeeds.select": "Semi non selezionate",
  "availableSeeds.select.plant": "Che seme vorresti selezionare e piantare?",
};

const base: Record<Base, string> = {
  "base.missing": "Nome mancante nella configurazione",
  "base.far.away": "Tu sei troppo lontano",
};

const basicTreasure: Record<BasicTreasure, string> = {
  "basic.treasure.missingKey": "Chiave mancante",
  "basic.treasure.needKey":
    "Hai bisogno di una chiave del tesoro per aprire questo scrigno",
  "rare.treasure.needKey":
    "Hai bisogno di una chiave rara per aprire questa cassa",
  "luxury.treasure.needKey":
    "Hai bisogno di una chiave di lusso per aprire questa cassa",
  "basic.treasure.getKey":
    "È possibile ottenere le chiavi del tesoro completando le attività per Bumpkins",
  "basic.treasure.goodLuck": "Buona fortuna!",
  "basic.treasure.key": "Chiave del tesoro",
  "basic.treasure.congratsKey": "Congratulazioni, hai la chiave!",
  "basic.treasure.openChest":
    "Vuole aprire il baule e richiedere una ricompensa?",
...
const beach: Record<Beach, string> = {
  "beach.party": "Stiamo lavorando sodo per preparare una festa in spiaggia.",
  "beach.ready":
    "Prepara la tua crema solare e gli ombrelli, l'estate sta arrivando!",
};

const beachLuck: Record<BeachLuck, string> = {
  "beachLuck.tryLuck": "Vuoi tentare la fortuna oggi?",
  "beachLuck.uncleFound":
    "Mio zio ha trovato un anello di diamanti scavando in questa spiaggia. Tutto quello che io continuo a trovare sono noiose monete SFL.",
  "beachLuck.grabShovel": "Prendi una pala e inizia a scavare.",
  "beachLuck.refreshesIn": "Aggiorna i tesori",
};

const beehive: Record<Beehive, string> = {
  "beehive.harvestHoney": "Raccogli miele",
  "beehive.noFlowersGrowing": "Nessun fiore sta crescendo",
  "beehive.beeSwarm": "sciame di api",
  "beehive.pollinationCelebration":
    "Celebrazione dell'impollinazione! I vostri raccolti vengono trattati con una spinta 0.2 da un amichevole sciame di api!",
};

const birdiePlaza: Record<BirdiePlaza, string> = {
  "birdieplaza.birdieIntro":
    "Ehi, io sono Birdie, la contadina più bella in giro!",
  "birdieplaza.admiringOutfit":
    "Ho notato che ammiri il mio outfit. Non è fantastico?!?",
  // Translate
  ...
  "birdieplaza.whatIsSeason": "Che cos'è una stagione?",
  ...
  "birdieplaza.newSeasonIntro":
    "Ogni 3 mesi viene introdotta una nuova stagione a Sunflower Land.",
  "birdieplaza.seasonQuests":
    "Questa stagione ha missioni emozionanti e oggetti da collezione rari che puoi guadagnare.",
...
const boostDescriptions: Record<BoostDescriptions, string> = {
  ...
  "description.speed.chicken.one":
    "I vostri polli ora produrranno le uova 10% più velocemente.",
  "description.speed.chicken.two": "Produces eggs 10% faster",
  "description.fat.chicken.one":
    "I tuoi polli ora richiedono il 10% in meno di grano per mangime.",
  "description.fat.chicken.two":
    "10% in meno di grano necessario per nutrire un pollo",
  "description.rich.chicken.one":
    "I tuoi polli ora produrranno il 10% in più di uova.",
  "description.rich.chicken.two": "Produce il 10% in più di uova",
  "description.ayam.cemani": "Il pollo più raro esistente!",
  "description.el.pollo.veloz.one":
    "I tuoi polli deporranno le uova 4 ore più velocemente!",
  "description.el.pollo.veloz.two":
    "Dammi quelle uova, veloce! Aumenta di 4 ore la velocità di deposizione delle uova.",
  "description.banana.chicken":
    "Un pollo che aumenta le banane. In che mondo viviamo.",
...
export const ITALIAN_TERMS: Record<TranslationKeys, string> = {
  ...achievementTerms,
  ...addSFL,
  ...auction,
  ...availableSeeds,
