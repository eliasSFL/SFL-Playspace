...
const generalTerms: Record<GeneralTerms, string> = {
  "2x.sale": "Giảm giá 2 lần",
  advanced: "Nâng cao",
  achievements: "Thành tựu",
  accept: "Chấp nhận:",
  "accepting.terms": "Accepting terms...",
  "amount.matic": "Số lượng MATIC",
  deposit: "Nạp",
  add: "Thêm",
  addSFL: "Nạp SFL",
  ...
  "alr.bought": "Đã mua!",
  "alr.claim": "Đã nhận!",
  "alr.completed": "Đã hoàn thành!",
  "alr.crafted": "Đã chế tạo!",
  "alr.minted": "Đã đúc!",
  auction: "Đấu giá",
  auctions: "Đấu giá",
  "available.all.year": "Khả dụng quanh năm ",
  available: "Khả dụng",
  back: "Quay lại",
  bait: "Mồi",
  balance: "Tài sản: ",
  basket: "Giỏ",
  "beach.bounty": "Châu báu",
  beta: "Thử nghiệm",
  bid: "Đấu thầu",
  bounty: "Tiền thưởng",
  build: "Xây dựng",
  ...
  chest: "Rương",
  chores: "Việc vặt",
  "choose.wisely": "Hãy lựa chọn một cách thông minh!",
  claim: "Nhận",
  "claim.gift": "Nhận quà",
  "claim.skill": "Nhận kỹ năng",
  clear: "Dọn dẹp",
  close: "Đóng",
  collect: "Thu thập",
  ...
  crops: "Nông sản",
  "currently.Unavailable": "Hiện không khả dụng!",
  danger: "Nguy hiểm",
  date: "Thời gian",
  decoration: "Trang trí",
  deliver: "Giao",
  deliveries: "Giao hàng",
  "deliveries.closed": "Giao hàng đã đóng cửa",
  delivery: "Giao hàng",
  details: "Chi tiết:",
  donate: "Tặng",
  donating: "Đang tặng",
  "drafting.noitem": "Không có vật phẩm khả dụng để đăng",
  "drafting.select": "Chọn vật phẩm để đăng",
  "drafting.trade.detail": "Chi tiết giao dịch",
  dragMe: "Kéo tôi",
  earn: "Thu nhập",
  "easter.eggs": "Trứng Phục Sinh",
  egg: "Trứng",
  empty: "Trống rỗng",
  "enjoying.event": "Bạn có đang tận hưởng sự kiện?",
  equip: "Trang bị",
  error: "Lỗi",
  exchange: "Trao đổi",
  exotics: "Kì lạ",
  "expand.land": "Mở rộng Vùng Đất của bạn",
  expand: "Mở rộng",
  explore: "Khám phá",
  farm: "Nông trại",
  "farm.storage": "Nhà kho",
  featured: "Tính năng",
  fee: "Phí",
  "feed.bumpkin": "Cho Bumpkin ăn",
  fertilisers: "Phân bón",
  fish: "Cá",
  "fish.caught": "Đã bắt được Cá: ",
  flowers: "Hoa",
  "flowers.found": "Đã tìm thấy Hoa",
  foods: "Thức ăn",
  for: "để",
  "for.info.wearable": "Thêm thông tin về trang phục này",
  forbidden: "Cấm",
  "free.trade": "Trao đổi tự do: {{freeTrades}}",
  fruit: "Hoa quả",
  fruits: "Hoa quả",
  gift: "Quà tặng",
  "go.home": "Quay về Nhà",
  "goblin.delivery":
    "Yêu tinh giữ một phần hàng của chúng trong kho bạc. Xem thêm ở {{opensea}}",
  gotIt: "Hiểu rồi",
  goto: "Đi đến",
  "grant.wish": "Thêm điều ước mới",
  guide: "Chỉ dẫn",
  ...
  left: "Rời đi",
  "let'sDoThis": "Hãy làm thôi!",
  "lets.go": "Đi nào!",
  limit: "Giới hạn",
  "linked.wallet": "Ví đã liên kết",
  list: "Danh sách",
  "list.trade": "Đăng bán",
  loading: "Đang tải",
  locked: "Đã bị khoá",
  logout: "Đăng xuất",
  "loser.refund": "Hoàn trả tài nguyên",
  lvl: "Cấp độ",
  maintenance: "Bảo trì",
  "make.wish": "Ước một điều ước",
  "making.wish": "Đang ước",
  max: "Tối đa",
  message: "Nhắn tin",
  messages: "Tin nhắn",
  minimum: "Tối thiểu",
  ...
  music: " m nhạc",
  next: "Tiếp theo",
  "next.order": "Đơn tiếp theo:",
  nextSkillPtLvl: "Điểm Năng Lực tiếp theo: Cấp độ",
  no: "Không",
  "no.delivery.avl": "Hiện tại chưa có đơn giao hàng nào",
  "no.event": "Hiện tại chưa có Chương Trình nào",
  "no.have.bumpkin": "Bạn không có Bumpkin!",
  "no.limits.exceeded": "No limits exceeded",
  "no.mail": "Your mailbox is empty.",
  "no.obsessions": "No Obsessions",
  "no.thanks": "Không, cám ơn",
  "ocean.fishing": "Câu Cá biển",
  off: "Off",
  "offer.end": "Ưu đãi Hết hạn trong vòng:",
  ok: "OK",
  on: "On",
  open: "Mở",
  "open.gift": "Mở Phần Thưởng",
  "pass.required": "Pass Required",
  place: "Đặt lên",
  "place.map": "Đặt lên Bản đồ",
...
export const VIETNAMESE_TERMS: Record<TranslationKeys, string> = {
  ...achievementTerms,
  ...addSFL,
  ...auction,
  ...availableSeeds,
