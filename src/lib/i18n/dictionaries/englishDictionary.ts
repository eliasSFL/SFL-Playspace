...
const animalName: Record<AnimalName, string> = {
  cow: "Cow",
  chicken: "Chicken",
  pig: "Pig",
  sheep: "Sheep",
...
const collectibleName: Record<CollectibleName, string> = {
  "sunflower.statue": "",
  "potato.statue": "",
  "christmas.tree": "",
  scarecrow: "",
...
const seedName: Record<SeedName, string> = {
  "sunflower.seed": "Sunflower Seed",
  "potato.seed": "Potato Seed",
  "pumpkin.seed": "Pumpkin Seed",
  "carrot.seed": "Carrot Seed",
  "cabbage.seed": "Cabbage Seed",
  "beetroot.seed": "Beetroot Seed",
  "cauliflower.seed": "Cauliflower Seed",
  "parsnip.seed": "Parsnip Seed",
  "radish.seed": "Radish Seed",
  "wheat.seed": "Wheat Seed",
  "kale.seed": "Kale Seed",
  "apple.seed": "Apple Seed",
  "blueberry.seed": "Blueberry Seed",
  "orange.seed": "Orange Seed",
  "eggplant.seed": "Eggplant Seed",
  "corn.seed": "Corn Seed",
  "banana.plant": "Banana Plant",
};

const toolName: Record<ToolName, string> = {
  axe: "Axe",
  pickaxe: "Pickaxe",
  ...
  hammer: "Hammer",
  rod: "Rod",
  "rusty.shovel": "Rusty Shovel",
  shovel: "Shovel",
  "sand.shovel": "Sand Shovel",
  "sand.drill": "Sand Drill",
};

const cropFruitName: Record<CropFruitName, string> = {
  sunflower: "Sunflower",
  potato: "Potato",
  pumpkin: "Pumpkin",
  cabbage: "Cabbage",
...
const foodDrinkName: Record<FoodDrinkName, string> = {
  "pumpkin.soup": "Pumpkin Soup",
  "roasted.cauliflower": "Roasted Cauliflower",
  sauerkraut: "Sauerkraut",
  "radish.pie": "Radish Pie",
  "sunflower.cake": "Sunflower Cake",
  "potato.cake": "Potato Cake",
  "pumpkin.cake": "Pumpkin Cake",
  "carrot.cake": "Carrot Cake",
  "cabbage.cake": "Cabbage Cake",
  "beetroot.cake": "Beetroot Cake",
  "cauliflower.cake": "Cauliflower Cake",
  "parsnip.cake": "Parsnip Cake",
  "radish.cake": "Radish Cake",
  "wheat.cake": "Wheat Cake",
  "boiled.eggs": "Boiled Eggs",
  "bumpkin.broth": "Bumpkin Broth",
  "bumpkin.salad": "Bumpkin Salad",
  "goblins.treat": "Goblin's Treat",
  "mashed.potato": "Mashed Potato",
  "cauliflower.burger": "Cauliflower Burger",
  "club.sandwich": "Club Sandwich",
  "roast.veggies": "Roast Veggies",
  pancakes: "Pancakes",
  "apple.pie": "Apple Pie",
  "blueberry.jam": "Blueberry Jam",
  "fermented.carrots": "Fermented Carrots",
  "honey.cake": "Honey Cake",
  "kale.mushroom.pie": "Kale & Mushroom Pie",
  "kale.stew": "Kale Stew",
  "mushroom.jacket.potatoes": "Mushroom Jacket Potatoes",
  "mushroom.soup": "Mushroom Soup",
  "orange.cake": "Orange Cake",
  "sunflower.crunch": "Sunflower Crunch",
  "reindeer.carrot": "Reindeer Carrot",
  "pirate.cake": "Pirate Cake",
  "bumpkin.roast": "Bumpkin Roast",
  "goblin.brunch": "Goblin Brunch",
  "fruit.salad": "Fruit Salad",
  "kale.omelette": "Kale Omeletter",
  "cabbers.mash": "Cabbers n Mash",
  "fancy.fries": "Fancy Fries",
  "bumpkin.ganoush": "Bumpkin Ganoush",
  cornbread: "Cornbread",
  "eggplant.cake": "Eggplant Cake",
  popcorn: "Popcorn",
  chowder: "Chowder",
  gumbo: "Gumbo",
  ...
  "purple.smoothie": "Purple Smoothie",
  "power.smoothie": "Power Smoothie",
  "bumpkin.detox": "Bumpkin Detox",
  "banana.blast": "Banana Blast",
};

const resourceName: Record<ResourceName, string> = {
  wood: "Wood",
  stone: "Stone",
  iron: "Iron",
  gold: "Gold",
...
const baitName: Record<BaitName, string> = {
  earthworm: "Earthworm",
  Grub: "Grub",
  "Red Wiggler": "Red Wiggler",
  "Fishing Lure": "Fishing Lure",
};

const landResourceName: Record<LandResourceName, string> = {
  tree: "Tree",
...
const legacySkills: Record<LegacySkills, string> = {
  "green.thumb": "Green Thumb",
  "barn.manager": "Barn Manager",
  "seed.specialist": "Seed Specialist",
  wrangler: "Wrangler",
...
const couponName: Record<CouponName, string> = {
  "beta.pass": "Beta Pass",
  "red.envelope": "Red Envelope",
  "love.letter": "Love Letter",
  "block.buck": "Block Buck",
  "solar.flare.ticket": "Solar Flare Ticket",
  "dawn.breaker.ticket": "Dawn Breaker Ticket",
  "crow.feather": "Crow Feather",
  "gold.pass": "Gold Pass",
  "potion.ticket": "Potion Ticket",
  "bud.ticket": "Bud Ticket",
  "bud.seedling": "Bud Seedling",
  "mermaid.scale": "Mermaid Scale",
  "community.coin": "Community Coin",
  "sunflower.supporter": "Sunflower Supporter",
};

const bannerName: Record<BannerName, string> = {
  "solar.flare.banner": "Solar Flare Banner",
  "dawn.breaker.banner": "Dawn Breaker Banner",
  "witches.eve.banner": "Witches' Eve Banner",
  "catch.the.kraken.banner": "Catch the Kraken Banner",
  "human.war.banner": "Human War Banner",
  "goblin.war.banner": "Goblin War Banner",
};

const countryFlagName: Record<CountryFlagName, string> = {
  "flag.australia": "Australian Flag",
  "flag.belgian": "Belgium Flag",
  "flag.brazil": "Brazilian Flag",
  "flag.china": "Chinese Flag",
  "flag.finland": "Finnish Flag",
  "flag.germany": "German Flag",
  "flag.indonesia": "Indonesian Flag",
  "flag.india": "Indian Flag",
  "flag.iran": "Iranian Flag",
  "flag.italy": "Italian Flag",
  "flag.japan": "Japanese Flag",
  "flag.morocco": "Moroccan Flag",
  "flag.netherlands": "Dutch Flag",
  "flag.philippines": "Filipino Flag",
  "flag.poland": "Polish Flag",
  "flag.portugal": "Portuguese Flag",
  "flag.russia": "Russian Flag",
  "flag.saudi.arabia": "Saudi Arabian Flag",
  "flag.south.korea": "South Korean Flag",
  "flag.spain": "Spanish Flag",
  "flag.thailand": "Thailand Flag",
  "flag.turkey": "Turkish Flag",
  "flag.ukraine": "Ukrainian Flag",
  "flag.america": "American Flag",
  "flag.vietnam": "Vietanamese Flag",
  "flag.canada": "Canadian Flag",
  "flag.singapore": "Singaporean Flag",
  "flag.britain": "British Flag",
  "flag.sierra.leone": "Sierra Leone Flag",
  "flag.romania": "Romanian Flag",
  "flag.algeria": "Algerian Flag",
  "flag.mexico": "Mexican Flag",
  "flag.dominican.republic": "Domanican Republic Flag",
  "flag.argentina": "Argentinian Flag",
  "flag.lithuania": "Lithuanian Flag",
  "flag.malaysia": "Malaysian Flag",
  "flag.colombia": "Colombian Flag",
  "flag.rainbow": "Rainbow Flag",
  "flag.goblin": "Goblin Flag",
  "flag.pirate": "Pirate Flag",
  "flag.sunflower": "Sunflower Flag",
};

const buildingName: Record<BuildingName, string> = {
  market: "Market",
  "fire.pit": "Fire Pit",
  workbench: "Workbench",
  tent: "Tent",
...
const fishName: Record<FishName, string> = {
  anchovy: "Anchovy",
  ...
  "twilight.anglerfish": "Twilight Anglerfish",
  "starlight.tuna": "Starlight Tuna",
  "radiant.ray": "Radiant Ray",
  "phantom.barracuda": "Phantom Barracuda",
  "gilded.swordfish": "Gilded Swordfish",
};

const beachBountyName: Record<BeachBountyName, string> = {
  crab: "Crab",
  "old.bottle": "Old Bottle",
  "sea.cucumber": "Sea Cucumber",
  seaweed: "Seaweed",
  starfish: "Starfish",
  "wooden.compass": "Wooden Compass",
  "iron.compass": "Iron Compass",
  pipi: "Pipi",
  "emerald.compass": "Emerald Compass",
  "clam.shell": "Clam Shell",
  coral: "Coral",
  pearl: "Pearl",
  "pirate.bounty": "Pirate Bounty",
};

const exoticName: Record<ExoticName, string> = {
  "black.magic": "Black Magic",
  "golden.helios": "Golden Helios",
  chiogga: "Chiogga",
  "purple.cauliflower": "Purple Cauliflower",
  "adirondack.potato": "Adirondack Potat",
  "warty.goblin.pumpkin": "Warty Goblin Pumpkin",
